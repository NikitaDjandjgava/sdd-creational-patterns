...
class CampaignBuilder:
    ...
    def build(self) -> Campaign:
        ...
        if not self._creatives or any(
            not creative["headline"] or not creative["image_url"]
            for creative in self._creatives
        ):
            raise ValueError("At least one creative with a headline and image URL is required")
